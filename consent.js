...
(function () {
  ...
  var STYLE = [
    ...
    '.ccx-consent__card{pointer-events:auto;width:100%;max-width:44rem;',
      ...
      'padding:1.125rem 1.25rem;border-radius:18px;',
    ...
    '.ccx-consent__title{margin:0 0 .25rem;font-size:.9375rem;font-weight:600;color:#1d1d1f;}',
    '.ccx-consent__text{margin:0;font-size:.8125rem;line-height:1.5;color:#6e6e73;font-weight:400;}',
    '.ccx-consent__link{color:#0066cc;text-decoration:underline;text-decoration-color:rgba(0,102,204,.35);text-underline-offset:2px;}',
    '.ccx-consent__link:hover{text-decoration-color:currentColor;}',
    ...
    '.ccx-consent__btn{flex:1 1 auto;min-width:7rem;min-height:44px;padding:0 1.25rem;border-radius:980px;',
      'font-family:inherit;font-size:.875rem;font-weight:500;line-height:1.2;cursor:pointer;',
      'transition:background-color .15s ease;}',
    '.ccx-consent__btn:focus-visible{outline:2px solid #0071e3;outline-offset:2px;}',
    '.ccx-consent__btn--ghost{background:#fff;color:#1d1d1f;border:1px solid #d2d2d7;}',
    '.ccx-consent__btn--ghost:hover{background:#f0f0f4;}',
    '.ccx-consent__btn--solid{background:#1d1d1f;color:#fff;border:1px solid #1d1d1f;}',
    '.ccx-consent__btn--solid:hover{background:#000;}',
